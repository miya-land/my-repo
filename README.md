...
- ログのグループ化もできる
    - ログの流量が増えてくるとわかりづらくなるので、グループ化もできるということを調べられるように覚えておく

### 14

- 通知
    - 色々通知できる
    - slackにも通知可能で、事前にワークスペースでGithub連携を許可する
        - slackapi/slack-github-action アクションを使える
        - レビュー完了したら、通知するとかもできるのかなーとか思ったり、、、

### 15

- 複数ジョブの並列実行
    - 複数ジョブを定義するとデフォルトでは並列実行される
    - 適切にジョブを分割すると、ワークフロー全体の実行時間が短縮できる
